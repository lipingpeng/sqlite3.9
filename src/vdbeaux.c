...
int sqlite3VdbeAddOp4(
  ...
  int addr = sqlite3VdbeAddOp3(p, op, p1, p2, p3);¡//ÔÚVDBEÖÐÌí¼ÓÒ»¸öÐÂµÄ²Ù×÷Âëµ½µ±Ç°ÁÐ±íÖÐ£¬·µ»ØÐÂµÄÖ¸ÁîµÄµØÖ·
  sqlite3VdbeChangeP4(p, addr, zP4, p4type);//ÎªÒ»¸öÌØ¶¨µÄÖ¸Áî¸Ä±ä²Ù×÷ÊýP4 µÄÖµ¡£
  return addr;//·µ»ØÐÞ¸Ä¹ýµÄÖ¸ÁîµÄµØÖ·
}
